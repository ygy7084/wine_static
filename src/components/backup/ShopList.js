...
class ShopList extends React.Component {
  ...
  render() {
    ...
    for(const obj of showList) {
      obj.memoReduced = '';
      if (obj.memo && obj.memo.length > 10) {
        obj.memoReduced = obj.memo.substring(0, 7).concat('...');
      }
    }
    return (
      <StyleRoot>
            ...
            <ButtonGroup>
              ...
              </DropdownButton>
              {
                this.props.onlyView ?
                  ...
                  <Button
                    bsStyle="success"
                    onClick={this.props.shopInsertClick}
                  >매장 추가</Button>
              }
              <Button
                bsStyle="primary"
              ...
              >새로 고침</Button>
              {
                this.props.onlyView ? null :
                  <Button
                    bsStyle="danger"
                    onClick={this.props.shopRemoveAllClick}
                  >전부 삭제</Button>
              }
            </ButtonGroup>
          </div>
          ...
          >
            <thead>
              <tr>
                ...
                <th style={[styles.table_th.base, styles.table_th.memo]}>메모</th>
              </tr>
            </thead>
            <tbody>
              {
...
export default Radium(ShopList);
