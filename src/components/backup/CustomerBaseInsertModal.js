...
class CustomerBaseInsertModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      name: '',
        ...
        >
          ...
          <ModalFooter>
            <Button
              bsStyle="success"
              bsSize="large"
              onClick={this.customerBaseInsert}
            >추가</Button>
            <Button
              bsSize="large"
              onClick={() => {
...
export default CustomerBaseInsertModal;
