...
class VintageListForSale extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1,
    ...
    this.insertSale = this.insertSale.bind(this);
  }
...
export default Radium(VintageListForSale);
