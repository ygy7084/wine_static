        ...
        <div>
          <div style={styles.leftButtons}>
            <ButtonGroup>
              ...
              <Button
                bsStyle="success"
                onClick={this.props.customerBaseInsertClick}
              >고객 추가</Button>
              <Button
                bsStyle="primary"
              ...
              <Button
                bsStyle="danger"
                onClick={this.props.customerBaseRemoveAllClick}
              >전부 삭제</Button>
            </ButtonGroup>
          </div>
                ...
                showList.map((item, i) =>
                  (
                    <tr
                      key={item._id}
                      onClick={() =>
                        this.props.customerBaseClick(item)
                      }
...
export default Radium(CustomerBaseList);
